...
TC_DIR="$(pwd)/tc/clang"
DEFCONFIG="vendor/kona-not_defconfig vendor/samsung/kona-sec-not.config vendor/samsung/$DEVICE.config vendor/not/ksu.config vendor/not/nethunter.config vendor/not/droidspace.config"
